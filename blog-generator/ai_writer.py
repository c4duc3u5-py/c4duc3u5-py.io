...
class AIWriter:
    ...
    def _generate_content(self, brief: PostBrief) -> str:
        ...
        system_prompt = (
            ...
            "- Write EVERYTHING in English. The entire post MUST be in English.\n"
            "- All prices MUST use the £ symbol (British Pounds Sterling). NEVER use $ or USD or €.\n"
            "- You are writing for a UK audience on ebay.co.uk.\n"
            "- If any product titles or descriptions below are NOT in English (e.g. Czech, German, French), "
            "you MUST translate them to English or use the closest English equivalent. "
            "NEVER copy non-English text directly into the blog post.\n"
            "- Conditions like 'Nový', 'Použitý', 'Zcela nový' should be written as "
            "'New', 'Used', 'Brand New' etc.\n\n"
